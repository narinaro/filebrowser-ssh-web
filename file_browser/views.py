...
# Get length of Array and pass it to template
    ...
    if folderQuantity < 2:
        responseFoldersAndPaths  = list(zip(responseFolderPathsArray, responseFoldersArray))
    else:
        ...
        responseFoldersAndPaths  = list(zip(folderQuantityArray, responseFolderPathsArray, responseFoldersArray))
